...
function fumerolesStyle(feature) {
	return {
		weight: 2,
		//opacity: 1,
		color: 'blue',
...
// control that shows state info on hover
		...
		$.getJSON(fumerolesurl, function (data) {
		    fumeroles.addData(data).setStyle(fumerolesStyle);
		    fumeroles.eachLayer.pop_Fumeroles
		    fumeroles.eachLayer.doPointToLayerFumeroles
		});
		...
		$.getJSON(wellsurl, function (data) {
		    ...
		    wells.eachLayer.pop_Wells
		    wells.eachLayer.doPointToLayerWells
		});
		...
		$.getJSON(contoursurl, function (data) {
		    contours.addData(data).setStyle(contourStyle);
		    contours.eachLayer.pop_Contours
		});
		...
		$.getJSON(featureurl, function (data) {
		    ...
		    feature.eachLayer.pop_Infrastructure	
		});
