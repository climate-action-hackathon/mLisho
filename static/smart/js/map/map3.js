...
//Categories of well
var categories = {
    'GDC' : {desc: "GDC", icon:"alcohol.png"},
    'GRD' : {desc: "GRD", icon:"cybers.png"},
    'HYANG' : {desc: "HYANG", icon:"retail_shops.png"},
    'OTHERS' : {desc: "OTHERS", icon:"hotels.png"},
...
// Layer control, setting up 1 layer per category
    ...
    for (var icat in categories) {
        ...
        var cat = categories[icat],
            desc = '<img class="layer-control-img" src="../static/smart/img/owners/'+ cat.icon + '">' + cat.desc;           
...
var options = {
        ...
        showResultFct: function(feature, container) {
            ...
            var cat = props.well_owner ? props.well_owner : id
            var info = '' + cat + props.id + ', ' + props.well_name;
    ...
    // Load the data
    jQuery.getJSON(wells, function(data) {
        displayFeatures(data.features, layers, icons);
        var props = ['id', 'well_owner', 'well_name'];
